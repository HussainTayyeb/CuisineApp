...
public class IndGps extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_ind_gps);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Resturant = (new LatLng  (52.520470, 13.413260));

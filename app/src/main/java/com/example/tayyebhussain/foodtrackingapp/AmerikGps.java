...
public class AmerikGps extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_amerik_gps);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Resturant = (new LatLng  (52.500790, 13.443370));
        mMap.addMarker (new MarkerOptions ().position (Resturant)
                .title ("American Resturant")

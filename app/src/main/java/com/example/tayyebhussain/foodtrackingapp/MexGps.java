...
public class MexGps extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_mex_gps);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Resturant = (new LatLng  (52.447310, 13.577010));
        mMap.addMarker (new MarkerOptions ().position (Resturant)
                .title ("Mexican Resturant")

...
public class ItaGps extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_ita_gps);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Resturant = (new LatLng  (52.519320, 13.409920));
        mMap.addMarker (new MarkerOptions ().position (Resturant)
                .title ("Italian Resturant")
